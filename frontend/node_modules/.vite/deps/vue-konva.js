...
var require_Util = __commonJS({
  "node_modules/konva/lib/Util.js"(exports) {
    ...
    var Transform = class _Transform {
      ...
      translate(x, y2) {
        this.m[4] += this.m[0] * x + this.m[2] * y2;
        this.m[5] += this.m[1] * x + this.m[3] * y2;
        return this;
      }
      scale(sx, sy) {
        this.m[0] *= sx;
      ...
      decompose() {
        ...
        if (a != 0 || b2 != 0) {
          ...
          result.rotation = b2 > 0 ? Math.acos(a / r) : -Math.acos(a / r);
          result.scaleX = r;
          result.scaleY = delta / r;
          result.skewX = (a * c + b2 * d) / delta;
          result.skewY = 0;
        } else if (c != 0 || d != 0) {
  ...
  "node_modules/konva/lib/Context.js"(exports) {
    ...
    var Context = class {
      ...
      arc(x, y2, radius, startAngle, endAngle, counterClockwise) {
        this._context.arc(x, y2, radius, startAngle, endAngle, counterClockwise);
      }
      ...
      bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y2) {
        this._context.bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y2);
      }
      clearRect(x, y2, width, height) {
        this._context.clearRect(x, y2, width, height);
      }
      clip(...args) {
      ...
      ellipse(x, y2, radiusX, radiusY, rotation, startAngle, endAngle, counterclockwise) {
        this._context.ellipse(x, y2, radiusX, radiusY, rotation, startAngle, endAngle, counterclockwise);
      }
      isPointInPath(x, y2, path, fillRule) {
        if (path) {
          return this._context.isPointInPath(path, x, y2, fillRule);
        }
        return this._context.isPointInPath(x, y2, fillRule);
      }
      fill(...args) {
        this._context.fill.apply(this._context, args);
      }
      fillRect(x, y2, width, height) {
        this._context.fillRect(x, y2, width, height);
      }
      strokeRect(x, y2, width, height) {
        this._context.strokeRect(x, y2, width, height);
      }
      fillText(text, x, y2, maxWidth) {
        if (maxWidth) {
          this._context.fillText(text, x, y2, maxWidth);
        } else {
          this._context.fillText(text, x, y2);
        }
      }
      measureText(text) {
      ...
      rect(x, y2, width, height) {
        this._context.rect(x, y2, width, height);
      }
      roundRect(x, y2, width, height, radii) {
        this._context.roundRect(x, y2, width, height, radii);
      }
      putImageData(imageData, dx, dy) {
        this._context.putImageData(imageData, dx, dy);
      }
      quadraticCurveTo(cpx, cpy, x, y2) {
        this._context.quadraticCurveTo(cpx, cpy, x, y2);
      }
      restore() {
      ...
      setTransform(a, b2, c, d, e, f) {
        this._context.setTransform(a, b2, c, d, e, f);
      }
      stroke(path2d) {
        if (path2d) {
      ...
      strokeText(text, x, y2, maxWidth) {
        this._context.strokeText(text, x, y2, maxWidth);
      }
      transform(a, b2, c, d, e, f) {
        this._context.transform(a, b2, c, d, e, f);
      }
      translate(x, y2) {
        this._context.translate(x, y2);
      }
      _enableTrace() {
  ...
  "node_modules/konva/lib/Node.js"(exports) {
    ...
    var Node = class _Node {
      ...
      cache(config) {
        ...
        let width = Math.ceil(conf.width || rect.width), height = Math.ceil(conf.height || rect.height), pixelRatio = conf.pixelRatio, x = conf.x === void 0 ? Math.floor(rect.x) : conf.x, y2 = conf.y === void 0 ? Math.floor(rect.y) : conf.y, offset = conf.offset || 0, drawBorder = conf.drawBorder || false, hitCanvasPixelRatio = conf.hitCanvasPixelRatio || 1;
        if (!width || !height) {
        ...
        sceneContext.save();
        hitContext.save();
        sceneContext.translate(-x, -y2);
        hitContext.translate(-x, -y2);
      ...
      setAbsolutePosition(pos) {
        const { x, y: y2, ...origTrans } = this._clearTransform();
        this.attrs.x = x;
        this.attrs.y = y2;
        this._clearCache(TRANSFORM);
      ...
      move(change) {
        let changeX = change.x, changeY = change.y, x = this.x(), y2 = this.y();
        if (changeX !== void 0) {
          x += changeX;
        }
        if (changeY !== void 0) {
      ...
      _getAbsoluteTransform(top) {
        ...
        if (top) {
          ...
          if (transformsEnabled === "all") {
            ...
            at.translate(x - offsetX, y2 - offsetY);
          }
          at.dirty = false;
          return at;
        }
      ...
      _getTransform() {
        var _a, _b;
        const m2 = this._cache.get(TRANSFORM) || new Util_1.Transform();
        m2.reset();
        const x = this.x(), y2 = this.y(), rotation = Global_1.Konva.getAngle(this.rotation()), scaleX = (_a = this.attrs.scaleX) !== null && _a !== void 0 ? _a : 1, scaleY = (_b = this.attrs.scaleY) !== null && _b !== void 0 ? _b : 1, skewX = this.attrs.skewX || 0, skewY = this.attrs.skewY || 0, offsetX = this.attrs.offsetX || 0, offsetY = this.attrs.offsetY || 0;
        if (x !== 0 || y2 !== 0) {
          m2.translate(x, y2);
        }
        if (rotation !== 0) {
      ...
      _toKonvaCanvas(config) {
        ...
        const stage = this.getStage(), x = config.x !== void 0 ? config.x : Math.floor(box.x), y2 = config.y !== void 0 ? config.y : Math.floor(box.y), pixelRatio = config.pixelRatio || 1, canvas = new Canvas_1.SceneCanvas({
    ...
    var Stage = class extends Container_1.Container {
      ...
      setPointersPositions(evt) {
        ...
        if (evt.touches !== void 0) {
          ...
          this._pointerPositions = [{ x, y: y2, id: Util_1.Util._getFirstPointerId(evt) }];
          this._changedPointerPositions = [
            { x, y: y2, id: Util_1.Util._getFirstPointerId(evt) }
          ];
        }
      }
...
var require_Tween = __commonJS({
  "node_modules/konva/lib/Tween.js"(exports) {
    ...
    exports.Easings = {
      BackEaseIn(t, b2, c, d) {
        const s = 1.70158;
        return c * (t /= d) * t * ((s + 1) * t - s) + b2;
      },
      BackEaseOut(t, b2, c, d) {
        const s = 1.70158;
        return c * ((t = t / d - 1) * t * ((s + 1) * t + s) + 1) + b2;
      },
      BackEaseInOut(t, b2, c, d) {
        let s = 1.70158;
        if ((t /= d / 2) < 1) {
          return c / 2 * (t * t * (((s *= 1.525) + 1) * t - s)) + b2;
        }
        return c / 2 * ((t -= 2) * t * (((s *= 1.525) + 1) * t + s) + 2) + b2;
      },
      ElasticEaseIn(t, b2, c, d, a, p) {
        let s = 0;
        if (t === 0) {
          return b2;
        }
        ...
        return -(a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p)) + b2;
      },
      ElasticEaseOut(t, b2, c, d, a, p) {
        let s = 0;
        if (t === 0) {
          return b2;
        }
        ...
        return a * Math.pow(2, -10 * t) * Math.sin((t * d - s) * (2 * Math.PI) / p) + c + b2;
      },
      ElasticEaseInOut(t, b2, c, d, a, p) {
        let s = 0;
        if (t === 0) {
          return b2;
        }
        ...
        if (t < 1) {
          return -0.5 * (a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p)) + b2;
        }
        return a * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p) * 0.5 + c + b2;
      },
      BounceEaseOut(t, b2, c, d) {
        if ((t /= d) < 1 / 2.75) {
          return c * (7.5625 * t * t) + b2;
        } else if (t < 2 / 2.75) {
          return c * (7.5625 * (t -= 1.5 / 2.75) * t + 0.75) + b2;
        } else if (t < 2.5 / 2.75) {
          return c * (7.5625 * (t -= 2.25 / 2.75) * t + 0.9375) + b2;
        } else {
          return c * (7.5625 * (t -= 2.625 / 2.75) * t + 0.984375) + b2;
        }
      },
      BounceEaseIn(t, b2, c, d) {
        return c - exports.Easings.BounceEaseOut(d - t, 0, c, d) + b2;
      },
      BounceEaseInOut(t, b2, c, d) {
        if (t < d / 2) {
          return exports.Easings.BounceEaseIn(t * 2, 0, c, d) * 0.5 + b2;
        } else {
          return exports.Easings.BounceEaseOut(t * 2 - d, 0, c, d) * 0.5 + c * 0.5 + b2;
        }
      },
      EaseIn(t, b2, c, d) {
        return c * (t /= d) * t + b2;
      ...
      EaseInOut(t, b2, c, d) {
        ...
        return -c / 2 * (--t * (t - 2) - 1) + b2;
      },
      StrongEaseIn(t, b2, c, d) {
        return c * (t /= d) * t * t * t * t + b2;
      },
      StrongEaseOut(t, b2, c, d) {
        return c * ((t = t / d - 1) * t * t * t * t + 1) + b2;
      },
      StrongEaseInOut(t, b2, c, d) {
        if ((t /= d / 2) < 1) {
          return c / 2 * t * t * t * t * t + b2;
        }
        return c / 2 * ((t -= 2) * t * t * t * t + 2) + b2;
      },
      Linear(t, b2, c, d) {
        return c * t / d + b2;
      }
...
var require_BezierFunctions = __commonJS({
  "node_modules/konva/lib/BezierFunctions.js"(exports) {
    ...
    var getQuadraticArcLength = (xs, ys, t) => {
      ...
      const term = b2 + Math.sqrt(b2 * b2 + k) !== 0 ? k * Math.log(Math.abs((u2 + uuk) / (b2 + bbk))) : 0;
      return Math.sqrt(A) / 2 * (u2 * uuk - b2 * bbk + term);
    };
    ...
    var Path = class _Path extends Shape_1.Shape {
      ...
      static parsePathData(data) {
        ...
        for (n = 1; n < arr.length; n++) {
          ...
          const p = [];
          for (let j2 = 0, jlen = coords.length; j2 < jlen; j2++) {
            if (coords[j2] === "00") {
              p.push(0, 0);
              continue;
            }
            const parsed = parseFloat(coords[j2]);
            if (!isNaN(parsed)) {
              p.push(parsed);
            } else {
              p.push(0);
      ...
      static calcLength(x, y2, cmd, points) {
        let len, p1, p2, t;
        const path = _Path;
        switch (cmd) {
          case "L":
            return path.getLineLength(x, y2, points[0], points[1]);
          case "C":
            return (0, BezierFunctions_1.getCubicArcLength)([x, points[0], points[2], points[4]], [y2, points[1], points[3], points[5]], 1);
          case "Q":
            return (0, BezierFunctions_1.getQuadraticArcLength)([x, points[0], points[2]], [y2, points[1], points[3]], 1);
          case "A":
            len = 0;
            var start = points[4];
            var dTheta = points[5];
...
var require_Label = __commonJS({
  "node_modules/konva/lib/shapes/Label.js"(exports) {
    ...
    var Label = class extends Group_1.Group {
      ...
      _sync() {
        let text = this.getText(), tag = this.getTag(), width, height, pointerDirection, pointerWidth, x, y2, pointerHeight;
        if (text && tag) {
          width = text.width();
          height = text.height();
    ...
    var Tag = class extends Shape_1.Shape {
      ...
      getSelfRect() {
        let x = 0, y2 = 0, pointerWidth = this.pointerWidth(), pointerHeight = this.pointerHeight(), direction = this.pointerDirection(), width = this.width(), height = this.height();
        if (direction === UP) {
          y2 -= pointerHeight;
...
var require_Sprite = __commonJS({
  "node_modules/konva/lib/shapes/Sprite.js"(exports) {
    ...
    var Sprite = class extends Shape_1.Shape {
      ...
      _sceneFunc(context) {
        const anim = this.animation(), index = this.frameIndex(), ix4 = index * 4, set = this.animations()[anim], offsets = this.frameOffsets(), x = set[ix4 + 0], y2 = set[ix4 + 1], width = set[ix4 + 2], height = set[ix4 + 3], image = this.image();
        ...
        if (image) {
          if (offsets) {
            ...
            context.drawImage(image, x, y2, width, height, offset[ix2 + 0], offset[ix2 + 1], width, height);
          } else {
            context.drawImage(image, x, y2, width, height, 0, 0, width, height);
          }
        }
      }
      _hitFunc(context) {
    ...
    var Star = class extends Shape_1.Shape {
      _sceneFunc(context) {
        ...
        for (let n = 1; n < numPoints * 2; n++) {
          ...
          const y2 = -1 * radius * Math.cos(n * Math.PI / numPoints);
          context.lineTo(x, y2);
        }
        context.closePath();
        context.fillStrokeShape(this);
      ...
      _sceneFunc(context) {
        ...
        for (n = 0; n < textArrLen; n++) {
          ...
          if (shouldUnderline) {
            ...
            context.lineTo(x + Math.round(lineWidth), y2);
    ...
    var Transformer = class extends Group_1.Group {
      ...
      _handleMouseMove(e) {
        ...
        if (this._movingAnchorName === "rotater") {
          ...
          let delta = Math.atan2(-y2, x) + Math.PI / 2;
          if (attrs.height < 0) {
            delta -= Math.PI;
          }
...
var require_Blur = __commonJS({
  "node_modules/konva/lib/filters/Blur.js"(exports) {
    ...
    function filterGaussBlurRGBA(imageData, radius) {
      ...
      let x, y2, i, p, yp, yi, yw, r_sum, g_sum, b_sum, a_sum, r_out_sum, g_out_sum, b_out_sum, a_out_sum, r_in_sum, g_in_sum, b_in_sum, a_in_sum, pr, pg, pb, pa, rbs;
...
var require_Emboss = __commonJS({
  "node_modules/konva/lib/filters/Emboss.js"(exports) {
    ...
    var Emboss = function(imageData) {
      const strength = this.embossStrength() * 10, greyLevel = this.embossWhiteLevel() * 255, direction = this.embossDirection(), blend = this.embossBlend(), data = imageData.data, w2 = imageData.width, h2 = imageData.height, w4 = w2 * 4;
      let dirY = 0, dirX = 0, y2 = h2;
      switch (direction) {
        case "top-left":
          dirY = -1;
          dirX = -1;
...
var require_HSL = __commonJS({
  "node_modules/konva/lib/filters/HSL.js"(exports) {
    ...
    var HSL = function(imageData) {
      const data = imageData.data, nPixels = data.length, v = 1, s = Math.pow(2, this.saturation()), h2 = Math.abs(this.hue() + 360) % 360, l = this.luminance() * 127;
      ...
      for (let i = 0; i < nPixels; i += 4) {
        ...
        b2 = data[i + 2];
        a = data[i + 3];
        data[i + 0] = rr * r + rg * g + rb * b2 + l;
        data[i + 1] = gr * r + gg * g + gb * b2 + l;
        data[i + 2] = br * r + bg * g + bb * b2 + l;
        data[i + 3] = a;
      }
    };
    exports.HSL = HSL;
  ...
  "node_modules/konva/lib/filters/HSV.js"(exports) {
    ...
    var HSV = function(imageData) {
      ...
      for (let i = 0; i < nPixels; i += 4) {
        ...
        b2 = data[i + 2];
        a = data[i + 3];
        data[i + 0] = rr * r + rg * g + rb * b2;
        data[i + 1] = gr * r + gg * g + gb * b2;
        data[i + 2] = br * r + bg * g + bb * b2;
        data[i + 3] = a;
      }
    };
    exports.HSV = HSV;
...
var require_Kaleidoscope = __commonJS({
  "node_modules/konva/lib/filters/Kaleidoscope.js"(exports) {
    ...
    var Kaleidoscope = function(imageData) {
      ...
      let x, y2, xoff, i, r, g, b2, a, srcPos, dstPos;
      ...
      for (y2 = 0; y2 < ySize; y2 += 1) {
        ...
        for (i = 0; i < power; i += 1) {
          for (x = 0; x < sectionSize + 1; x += 1) {
            ...
            b2 = scratchData.data[srcPos + 2];
            a = scratchData.data[srcPos + 3];
            dstPos = (xSize * y2 + sectionSize * 2 - x - 1) * 4;
            scratchData.data[dstPos + 0] = r;
            scratchData.data[dstPos + 1] = g;
            scratchData.data[dstPos + 2] = b2;
            scratchData.data[dstPos + 3] = a;
...
var require_Mask = __commonJS({
  "node_modules/konva/lib/filters/Mask.js"(exports) {
    ...
    var Node_1 = require_Node();
    var Validators_1 = require_Validators();
    function pixelAt(idata, x, y2) {
      let idx = (y2 * idata.width + x) * 4;
      const d = [];
...
var require_Pixelate = __commonJS({
  "node_modules/konva/lib/filters/Pixelate.js"(exports) {
    ...
    var Pixelate = function(imageData) {
      let pixelSize = Math.ceil(this.pixelSize()), width = imageData.width, height = imageData.height, x, y2, i, red, green, blue, alpha, nBinsX = Math.ceil(width / pixelSize), nBinsY = Math.ceil(height / pixelSize), xBinStart, xBinEnd, yBinStart, yBinEnd, xBin, yBin, pixelsInBin, data = imageData.data;
      if (pixelSize <= 0) {
  ...
  "node_modules/konva/lib/filters/Sepia.js"(exports) {
    ...
    var Sepia = function(imageData) {
      ...
      for (let i = 0; i < nPixels; i += 4) {
        ...
        const g = data[i + 1];
        const b2 = data[i + 2];
        data[i + 0] = Math.min(255, r * 0.393 + g * 0.769 + b2 * 0.189);
        data[i + 1] = Math.min(255, r * 0.349 + g * 0.686 + b2 * 0.168);
        data[i + 2] = Math.min(255, r * 0.272 + g * 0.534 + b2 * 0.131);
      }
    };
    exports.Sepia = Sepia;
  }
...
var require_Solarize = __commonJS({
  "node_modules/konva/lib/filters/Solarize.js"(exports) {
    ...
    var Solarize = function(imageData) {
      const data = imageData.data, w2 = imageData.width, h2 = imageData.height, w4 = w2 * 4;
      let y2 = h2;
      do {
        const offsetY = (y2 - 1) * w4;
        let x = w2;
...
var w = { key: true, style: true, elm: true, isRootInsert: true };
var y = ".vue-konva-event";
function P(a, o, t, i) {
  ...
  for (let r in o) {
    ...
    !c && (o[r] !== t[r] || i && o[r] !== (e == null ? void 0 : e.getAttr(r))) && (n = true, d[r] = o[r]);
  }
...
function O(a, o) {
  ...
  let e = false;
  i.forEach((d, n) => {
    d.getZIndex() !== n && (d.setZIndex(n), e = true);
  }), e && m(o);
}
var j = defineComponent({
  ...
  setup(a, { attrs: o, slots: t, expose: i }) {
    ...
    if (!e) return;
    const d = reactive({}), n = ref(null), r = new import_konva.default.Stage({
    ...
    return onMounted(() => {
      ...
      r.destroy();
    }), watch(() => a.config, l, { deep: true }), i({
      getStage: f,
      getNode: c
    }), console.log(o), () => {
      var s;
      return h("div", { ref: n, style: o == null ? void 0 : o.style }, (s = t.default) == null ? void 0 : s.call(t));
    };
  }
});
  ...
  return defineComponent({
    ...
    setup(t, { attrs: i, slots: e, expose: d }) {
      ...
      function s() {
        if (!n) return;
        const v = {};
        for (const h2 in n == null ? void 0 : n.vnode.props)
          h2.slice(0, 2) === "on" && (v[h2] = n.vnode.props[h2]);
        const _ = r || {}, k = {
          ...i,
          ...t.config,
          ...v
      ...
      return () => {
        var v;
        return p ? h("template", {}, (v = e.default) == null ? void 0 : v.call(e)) : null;
      };
    }
  });
}
function D(a, o, t) {
  const i = ref(null), e = ref("loading"), d = (n, r, c) => {
    e.value = "loading";
    const f = new Image();
  ...
  return watch(
    [
      ...
      o ? typeof o == "string" ? ref(o) : o : ref(void 0),
      t ? typeof t == "string" ? ref(t) : t : ref(void 0)
    ],
    ([n, r, c]) => {
      n && d(
        n,
